...
class UserController extends Controller
{
    #[OA\Get(
        ...
        summary: 'Opciones de filtro para usuarios',
        description: 'Retorna los valores disponibles para poblar los filtros del listado de usuarios (roles y tiendas).',
        operationId: 'userFilterOptions',
        security: [['sanctum' => []]],
        tags: ['Users']
    )]
    #[OA\Response(
                                ...
                                new OA\Property(
                                    ...
                                    items: new OA\Items(
                                        ...
                                        properties: [
                                            ...
                                            new OA\Property(property: 'name', type: 'string', example: 'STORE_ADMIN'),
                                        ]
                                    )
                                ),
                                new OA\Property(
                                    ...
                                    items: new OA\Items(
                                        ...
                                        properties: [
                                            ...
                                            new OA\Property(property: 'name', type: 'string', example: 'Ferretería El Tornillo'),
                                        ]
                                    )
                                ),
                            ]
    ...
    public function filterOptions(Request $request): JsonResponse
    {
        ...
        $storesQuery = Store::select('id', 'name')->orderBy('name');
